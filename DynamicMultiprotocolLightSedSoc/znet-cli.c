...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleConnectionCloseCommandArguments[] = {
  "the connection handle which should be closed",
  NULL
};
#endif


static EmberCommandEntry emberCommandPluginBleConnectionTable[] = {
  emberCommandEntryActionWithDetails("close", emberAfPluginBleConnectionCloseCommand, "u", "Close BLE connection", pluginBleConnectionCloseCommandArguments),
  emberCommandEntryTerminator(),
};
void emberAfPluginBleGapConnectionOpenCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapConnOpenCommandArguments[] = {
  "The BLE address of the target device",
  "The address type: 0=public, 1=random, 2=public resolved by the stack,  ...",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapDiscoverCommandArguments[] = {
  "The GAP discovery mode: 0=only limited discoverable devices, 1=limited ...",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapSetAdvParamsCommandArguments[] = {
  "minimum connection interval",
  "maximum connection interval",
  "Channel map indicating which of three channels will be used",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapSetBt5ModeCommandArguments[] = {
  "The handle index of advertisement",
  "The GAP discoverable mode: 0=non discoverable, 1=limited discoverable, ...",
  "The GAP connectable mode: 0=non connectable, 1=directed connectable, 2 ...",
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapSetConnParamsCommandArguments[] = {
  "minimum connection event interval",
  "maximum connection event interval",
  "number of connection intervals the slave can skip",
  "time before the connection is dropped",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapSetModeCommandArguments[] = {
  "The GAP discoverable mode: 0=non discoverable, 1=limited discoverable, ...",
  "The GAP connectable mode: 0=non connectable, 1=directed connectable, 2 ...",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGapUpdateConnParamsCommandArguments[] = {
  "connection handle",
  "minimum connection event interval",
  "maximum connection event interval",
  "number of connection intervals the slave can skip",
...
static EmberCommandEntry emberCommandPluginBleGapTable[] = {
  emberCommandEntryActionWithDetails("conn-open", emberAfPluginBleGapConnectionOpenCommand, "bu", "Open a GAP connection", pluginBleGapConnOpenCommandArguments),
  emberCommandEntryActionWithDetails("discover", emberAfPluginBleGapDiscoverCommand, "u", "Start a GAP discovery procedure", pluginBleGapDiscoverCommandArguments),
  emberCommandEntryActionWithDetails("set-adv-params", emberAfPluginBleSetAdvertisementParamsCommand, "vvu", "Set the GAP advertisement parameters", pluginBleGapSetAdvParamsCommandArguments),
  emberCommandEntryActionWithDetails("set-bt5-mode", emberAfPluginBleSetBt5GapModeCommand, "uuuvu", "Set the BT5 GAP mode", pluginBleGapSetBt5ModeCommandArguments),
  emberCommandEntryActionWithDetails("set-conn-params", emberAfPluginBleGapSetConnectionParamsCommand, "vvvv", "Set the GAP connection parameters", pluginBleGapSetConnParamsCommandArguments),
  emberCommandEntryActionWithDetails("set-mode", emberAfPluginBleSetGapModeCommand, "uu", "Set the GAP mode", pluginBleGapSetModeCommandArguments),
  emberCommandEntryActionWithDetails("update-conn-params", emberAfPluginBleConnectionSetParamsCommand, "vvvvv", "Set the GAP connection parameters for connection", pluginBleGapUpdateConnParamsCommandArguments),
  emberCommandEntryTerminator(),
};
void emberAfPluginBleGattDiscoverCharacteristicsCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGattDiscoverCharacteristicsCommandArguments[] = {
  "the connection handle on which discovery should be performed",
  "the service handle on which discovery should be performed",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGattDiscoverPrimaryServicesCommandArguments[] = {
  "the connection handle on which discovery should be performed",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGattSetCharacteristicNotificationCommandArguments[] = {
  "the connection handle for which the notification should be set",
  "the characteristic handle to set notification for",
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleGattWriteCharacteristicCommandArguments[] = {
...
static EmberCommandEntry emberCommandPluginBleGattTable[] = {
  emberCommandEntryActionWithDetails("discover-characteristics", emberAfPluginBleGattDiscoverCharacteristicsCommand, "uw", "GATT discovery of characteristics", pluginBleGattDiscoverCharacteristicsCommandArguments),
  emberCommandEntryActionWithDetails("discover-primary-services", emberAfPluginBleGattDiscoverPrimaryServicesCommand, "u", "GATT discovery of primary services", pluginBleGattDiscoverPrimaryServicesCommandArguments),
  emberCommandEntryActionWithDetails("set-characteristic-notification", emberAfPluginBleGattSetCharacteristicNotificationCommand, "uvu", "GATT set characteristic notification", pluginBleGattSetCharacteristicNotificationCommandArguments),
  emberCommandEntryActionWithDetails("write-characteristic", emberAfPluginBleGattWriteCharacteristicValueCommand, "uvub", "GATT write characteristic value", pluginBleGattWriteCharacteristicCommandArguments),
  emberCommandEntryTerminator(),
};
void emberAfPluginBleGetAddressCommand(void);
static EmberCommandEntry emberCommandPluginBleGetTable[] = {
  emberCommandEntryActionWithDetails("address", emberAfPluginBleGetAddressCommand, "", "Read the Bluetooth address", NULL),
  emberCommandEntryTerminator(),
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleSmDeleteBondingCommandArguments[] = {
  "the bonding handle to be deleted",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleSmIncreaseSecurityCommandArguments[] = {
  "the connection handle for which we want to increase the security level",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleSmSetBondableModeCommandArguments[] = {
  "The bondable mode: 0=new bondings not accepted, 1=bondings allowed",
  NULL
};
#endif


static EmberCommandEntry emberCommandPluginBleSmTable[] = {
  emberCommandEntryActionWithDetails("delete-all-bondings", emberAfPluginBleSecurityManagerDeleteAllBondingsCommand, "", "Delete all bondings", NULL),
  emberCommandEntryActionWithDetails("delete-bonding", emberAfPluginBleSecurityManagerDeleteBondingCommand, "u", "Delete bonding", pluginBleSmDeleteBondingCommandArguments),
  emberCommandEntryActionWithDetails("increase-security", emberAfPluginBleSecurityManagerIncreaseSecurityCommand, "u", "Increase the security level", pluginBleSmIncreaseSecurityCommandArguments),
  emberCommandEntryActionWithDetails("list-all-bondings", emberAfPluginBleSecurityManagerListAllBondingsCommand, "", "Send a command to get all the current bondings", NULL),
  emberCommandEntryActionWithDetails("set-bondable-mode", emberAfPluginBleSecurityManagerSetBondableModeCommand, "u", "Set the bondable mode", pluginBleSmSetBondableModeCommandArguments),
  emberCommandEntryTerminator(),
};
void emberAfPluginBleSetTxPowerCommand(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginBleSystemSetTxPowerCommandArguments[] = {
  "tx power to be set in 0.1dBm steps",
  NULL
};
#endif


static EmberCommandEntry emberCommandPluginBleSystemTable[] = {
  emberCommandEntryActionWithDetails("set-tx-power", emberAfPluginBleSetTxPowerCommand, "r", "Set the TX power", pluginBleSystemSetTxPowerCommandArguments),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginBleTable[] = {
  emberCommandEntrySubMenu("connection", emberCommandPluginBleConnectionTable, ""),
  emberCommandEntrySubMenu("gap", emberCommandPluginBleGapTable, ""),
  emberCommandEntrySubMenu("gatt", emberCommandPluginBleGattTable, ""),
  emberCommandEntrySubMenu("get", emberCommandPluginBleGetTable, ""),
  emberCommandEntryActionWithDetails("hello", emberAfPluginBleHelloCommand, "", "Can be used to check that Bluetooth stack is functional", NULL),
  emberCommandEntrySubMenu("sm", emberCommandPluginBleSmTable, ""),
  emberCommandEntrySubMenu("system", emberCommandPluginBleSystemTable, ""),
  emberCommandEntryTerminator(),
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningBleSetAdvertisementPrioritiesCommandArguments[] = {
  "Advertisement scheduler pritority - Min.",
  "Advertisement scheduler pritority - Max",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningBleSetConnectionInitPrioritiesCommandArguments[] = {
  "Connection init scheduler pritority - Min.",
  "Connection init scheduler pritority - Max.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningBleSetConnectionPrioritiesCommandArguments[] = {
  "Connection scheduler pritority - Min.",
  "Connection scheduler pritority - Max.",
  NULL
};
#endif
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningBleSetRailPriorityMappingCommandArguments[] = {
  "RAIL mapping offset.",
  "RAIL mapping range.",
  NULL
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningBleSetScanPrioritiesCommandArguments[] = {
  "Scan scheduler pritority - Min.",
  "Scan scheduler pritority - Max.",
  NULL
};
#endif


static EmberCommandEntry emberCommandPluginDmpTuningBleTable[] = {
  emberCommandEntryActionWithDetails("get-advertisement-priorities", emberAfPluginDmpTuningGetBleAdvertisementPrioritiesCommand, "", "Get BLE advertisement scheduler priorities.", NULL),
  emberCommandEntryActionWithDetails("get-connection-init-priorities", emberAfPluginDmpTuningGetBleConnectionInitPrioritiesCommand, "", "Get BLE connection init scheduler priorities.", NULL),
  emberCommandEntryActionWithDetails("get-connection-priorities", emberAfPluginDmpTuningGetBleConnectionPrioritiesCommand, "", "Get BLE connection scheduler priorities.", NULL),
  emberCommandEntryActionWithDetails("get-rail-priority-mapping", emberAfPluginDmpTuningGetBleRailMappingCommand, "", "Get BLE RAIL priority mapping.", NULL),
  emberCommandEntryActionWithDetails("get-scan-priorities", emberAfPluginDmpTuningGetBleScanPrioritiesCommand, "", "Get BLE scan scheduler priorities.", NULL),
  emberCommandEntryActionWithDetails("set-advertisement-priorities", emberAfPluginDmpTuningSetBleAdvertisementPrioritiesCommand, "uu", "Set BLE advertisement scheduler priorities.", pluginDmpTuningBleSetAdvertisementPrioritiesCommandArguments),
  emberCommandEntryActionWithDetails("set-connection-init-priorities", emberAfPluginDmpTuningSetBleConnectionInitPrioritiesCommand, "uu", "Set BLE connection init scheduler priorities.", pluginDmpTuningBleSetConnectionInitPrioritiesCommandArguments),
  emberCommandEntryActionWithDetails("set-connection-priorities", emberAfPluginDmpTuningSetBleConnectionPrioritiesCommand, "uu", "Set BLE connection scheduler priorities.", pluginDmpTuningBleSetConnectionPrioritiesCommandArguments),
  emberCommandEntryActionWithDetails("set-rail-priority-mapping", emberAfPluginDmpTuningSetBleRailMappingCommand, "uu", "Set BLE RAIL priority mapping.", pluginDmpTuningBleSetRailPriorityMappingCommandArguments),
  emberCommandEntryActionWithDetails("set-scan-priorities", emberAfPluginDmpTuningSetBleScanPrioritiesCommand, "uu", "Set BLE scan scheduler priorities.", pluginDmpTuningBleSetScanPrioritiesCommandArguments),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginDmpTuningRailTable[] = {
  emberCommandEntryActionWithDetails("disable-config-scheduler-events", emberAfPluginDmpTuningDisableRailConfigSchedulerEvents, "", "Disable the RAIL config scheduler events.", NULL),
  emberCommandEntryActionWithDetails("enable-config-scheduler-events", emberAfPluginDmpTuningEnableRailConfigSchedulerEvents, "", "Enable the RAIL config scheduler events.", NULL),
  emberCommandEntryActionWithDetails("get-config-scheduler-events-enabled", emberAfPluginDmpTuningGetRailConfigSchedulerEventsEnabled, "", "Get the enable state of the RAIL config scheduler events.", NULL),
  emberCommandEntryActionWithDetails("get-scheduled-event-counters", emberAfPluginDmpTuningGetRailScheduledEventCounters, "", "Get the RAIL config (un)scheduled event counters.", NULL),
  emberCommandEntryTerminator(),
};
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningZigbeeSetSchedulerPrioritiesCommandArguments[] = {
...
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginDmpTuningZigbeeSetSlipTimeCommandArguments[] = {
  "Slip time.",
  NULL
};
#endif
...
static EmberCommandEntry emberCommandPluginDmpTuningZigbeeTable[] = {
  emberCommandEntryActionWithDetails("get-scheduler-priorities", emberAfPluginDmpTuningGetZigbeeSchedulerPrioritiesCommand, "", "Get scheduler priorities for zigbee.", NULL),
  emberCommandEntryActionWithDetails("get-slip-time", emberAfPluginDmpTuningGetZigbeeSlipTimeCommand, "", "Get slip time for zigbee.", NULL),
  emberCommandEntryActionWithDetails("set-scheduler-priorities", emberAfPluginDmpTuningSetZigbeeSchedulerPrioritiesCommand, "uuu", "Set scheduler priorities for zigbee.", pluginDmpTuningZigbeeSetSchedulerPrioritiesCommandArguments),
  emberCommandEntryActionWithDetails("set-slip-time", emberAfPluginDmpTuningSetZigbeeSlipTimeCommand, "w", "Set slip time for zigbee.", pluginDmpTuningZigbeeSetSlipTimeCommandArguments),
  emberCommandEntryTerminator(),
};
static EmberCommandEntry emberCommandPluginDmpTuningTable[] = {
  emberCommandEntrySubMenu("ble", emberCommandPluginDmpTuningBleTable, ""),
  emberCommandEntrySubMenu("rail", emberCommandPluginDmpTuningRailTable, ""),
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("ble", emberCommandPluginBleTable, ""),
