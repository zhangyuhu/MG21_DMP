...
/*
 * This function is called by the Idle/Sleep plugin to check, if 
 * em4 sleep mode (involving restart) needs to be triggered.
 * This function needs to be implemented by the application, 
 * and conditionally return true for em4 reset.  
 */
